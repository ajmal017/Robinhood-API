...
class Robinhood:
    ...
    def getFundamentals(self, stock):
        ...
        fundamental_endpoint = 'https://api.robinhood.com/fundamentals/%s/' % stock.upper()
    ...
    def addToWatchlist(self, stock_idx):
        try:
            ...
            self.session.post(self.endpoints['watchlists'] + '/Default/bulk_add/', data=data)
        except Exception:
            pass
    ...
    def watchlist1(self):
        ...
        watch_list_instruments = self.session.get(self.endpoints['watchlists'] + 'Default/').json()
